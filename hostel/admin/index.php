...
<body>
	...
	<div class="login-page bk-img" style="background-image: url(img/agni.jpg);">
		<div class="form-content">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h1 class="text-center text-bold text-light mt-4x"><p style="color:navy;">Hostel Management System  South Eastern University</p></h1>
...
<p> Hostel Management System - South Eastern University</p>
</footer> </div>
