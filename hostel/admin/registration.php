...
<option value="">Select Faculty and Department</option>
...
<div class="col-sm-8">
<input type="text" name="regno" id="regno"  class="form-control" required="required" onBlur="check_availabilityidy()">
<span id="user-availability-id" style="font-size:12px;"></span>
</div>
</div>
...
<div class="col-sm-8">
<input type="email" name="email" id="email"  class="form-control" required="required" onBlur="checkAvailabilityemail()">
...
$("#loaderIcon").show();
jQuery.ajax({
url: "check_availabilitySecond.php",
...
alert('error');
	...
	<script>
function check_availabilityidy() {

$("#loaderIcon").show();
jQuery.ajax({
url: "check_availabilityidy.php",
data:'regno='+$("#regno").val(),
type: "POST",
success:function(data){
$("#user-availability-id").html(data);
$("#loaderIcon").hide();
},
error:function ()
{
