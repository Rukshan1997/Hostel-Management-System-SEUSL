...
<table width="100%" border="0">
  <?php $query=mysqli_query($con,"SELECT * FROM registration where emailid = '".$_GET['id']."'");
			  ...
			  <td colspan="2"  class="font1"><table width="100%" border="0">
                <tr>
                  ...
                  <td width="22%" valign="top" class="heading">Seater : </td>
                    ...
                    <tr>
                    <td width="12%" valign="top" class="heading">Fees per Year : </td>
...
<tr>
<td width="12%" valign="top" class="heading">Postal code: </td>
